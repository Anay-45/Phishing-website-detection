...
def generate_data_set(url):
    ...
    dataset.append(havingIP(url))
    dataset.append(long_url(url))
    dataset.append(have_at_symbol(url))
    dataset.append(redirection(url))
    dataset.append(prefix_suffix_separation(url))
    dataset.append(sub_domains(url))
    dataset.append(shortening_service(url))
    dataset.append(web_traffic(url))
    dataset.append(domain_registration_length(url))
    dataset.append(dns_record(url))
    dataset.append(statistical_report(url))
    dataset.append(age_domain(url))
    dataset.append(https_token(url))
    return dataset